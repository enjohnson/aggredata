...
public class EnergyPostRecordTest {
    ...
    public void testFullEnergyPostRecord() {
        ...
        try {
            ...
            Assert.assertEquals((String)energyPostRecord.getMtuRecords().get(0).getId(), "222222");
            Assert.assertEquals((String)energyPostRecord.getMtuRecords().get(1).getId(), "222223");
