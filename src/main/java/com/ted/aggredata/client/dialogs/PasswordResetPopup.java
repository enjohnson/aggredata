...
public class PasswordResetPopup extends PopupPanel {

    static Logger logger = Logger.getLogger(PasswordResetPopup.class.toString());


    interface MyUiBinder extends UiBinder<Widget, PasswordResetPopup> {
    }
    ...
    public PasswordResetPopup() {
        ...
        captionPanel.setCaptionHTML("<span style='color:white'>" + LogonConstants.INSTANCE.passwordPrompt() + "</span>");
